...
local TypesModule = require(ScriptParent:FindFirstChild("ConstantType"))
local AST = require(ScriptParent:FindFirstChild("AST"))
...
do 
	...
	local parseFunction = function(stream, isAnon)
		...
		return createFunctionTree(name, field, method, param
	end
